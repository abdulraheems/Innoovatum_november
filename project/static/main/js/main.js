...
function CommentReplyForm(div_id, comm_id, img) {
                        let elm = `
                          <form class="d-flex align-items-center border-top border-200 pt-3" style="border:none;">
                            ...
                            <input type="text" class="form-control rounded-pill ms-2 fs--1" aria-label="Write a Comment"
                              placeholder="Add a Public Reply" id="reply_comment_of_${comm_id}">
                            <div class="input-group-append">
                              <button class="input-group-text rounded-pill ms-2 fs--1 text-primary bg-white" type="button" 
